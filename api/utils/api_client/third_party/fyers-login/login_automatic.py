...
TOTP_KEY = "4R4DA4Z2CGOCKV6VGLTSY4KCX3JEHT4H"  # TOTP secret is generated when we enable 2Factor TOTP from myaccount portal
PIN = "0705"  # User pin for fyers account

REDIRECT_URI = "https://google.com"  # Redirect url from the app.
